...
import {initializeFormPage, renderRecipes} from './views';
...
export {getRecipes, createRecipe, removeRecipe, loadRecipes, updateRecipe, saveRecipes, removeIngredient, toggleIngredient, addIngredient, ingredientCountUpdate};